...
def tablo_olustur():
    ...
    cursor.execute("CREATE TABLE IF NOT EXISTS  Images(id INT PRIMARY KEY,file_name TEXT,height INT,width INT,coco_url TEXT,date_captured TEXT,license INT, FOREIGN KEY (license) REFERENCES Licenses (id))")  
